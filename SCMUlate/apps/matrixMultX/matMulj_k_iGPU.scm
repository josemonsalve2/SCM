...
loop_j:
  ...
  loop_k:
    ...
    // Load the tile of A
    COD LoadSqTileGPU_2048L R2048L_1, R64B_5, R64B_21; //Load A tile
    ...
    loop_i:
      ...
      COD LoadSqTileGPU_2048L R2048L_2, R64B_6, R64B_22; // Load B tile
      COD LoadSqTileGPU_2048L R2048L_3, R64B_7, R64B_23; // Load C tile

      // Do actual MM
      COD MatMultGPU_2048L R2048L_3, R2048L_1, R2048L_2;

      // Store partial result of C
      COD StoreSqTileGPU_2048L R2048L_3, R64B_7, R64B_23; // Store C tile
