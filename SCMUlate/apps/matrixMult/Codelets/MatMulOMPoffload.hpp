#ifndef __COD_MATMUL_OFFLOADING__
#define __COD_MATMUL_OFFLOADING__
...
// Loads tile of 128x128 
DEFINE_CODELET(StoreSqTileGPU_2048L, 2, scm::OP_IO::OP1_WR | scm::OP_IO::OP2_RD | scm::OP_IO::OP3_RD); 
