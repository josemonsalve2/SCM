...
namespace scm {
    ...
    enum FAULT_INJECTION_MODES {
      NO_FAULT_INJECTION,
      POISSON_FAULT_INJECTION,
      WEIBULL_FAULT_INJECTION,
    };
    const char *const FAULT_INJECTION_MODES_STR[] = {
        "FAULT_INJECTION_MODES::NO_FAULT_INJECTION",
        "FAULT_INJECTION_MODES::POISSON_FAULT_INJECTION",
        "FAULT_INJECTION_MODES::WEIBULL_FAULT_INJECTION"};
}
